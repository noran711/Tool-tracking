Due to the file size, the nnUNet_results folder could not be uploaded here to GitHub, so it can be found in the Google Drive folder under Tool_tracking_pen_results
